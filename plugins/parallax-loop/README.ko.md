...
parallax-loop은 같은 parallax 메커니즘 — 격리된 advisor가 매 라운드 미고려 영역을 surface하는
...
parallax-loop의 내구성 훅은 **uv**로 실행됩니다.
