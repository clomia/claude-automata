export const meta = {
  name: 'refine-docs',
  description: 'Documentation architecture optimization — verify every claim in every non-executable text against the code, cross-examine discrepancies into consensus, then apply only the highest-ROI fixes; code is never modified',
  phases: [
