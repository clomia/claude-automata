...
> **WARNING:** Parallax automates Claude via the CLI, so it must be used with the **Anthropic API** (Claude Console).
> Using it with a Claude Pro or Max subscription may put your account at risk of suspension.
